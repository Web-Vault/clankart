                                                  ...
                                                  <form action="edit_user_info" method="post">
                                                            ...
                                                            <div class="name-group">
                                                                      <div class="name-field form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="firstName" value="Aryan" name="firstName" placeholder="Enter first name" >
...
unset($__errorArgs, $__bag); ?>
                                                                      ...
                                                                      <div class="name-field form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="lastName" value="Lathigara" name="lastName" placeholder="Enter last name" >
                                                                                <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <div class="phone-input">
                                                                                ...
                                                                                <input type="text" class="form-control" id="contactNumber" name="contactNumber" value="1234567890"placeholder="Enter contact number" >
                                                                                <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <input type="text" class="form-control" id="address" name="address" placeholder="Enter address" value="Rajkot">
                                                                      <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <input type="text" class="form-control" id="pincode" value="000000" name="pincode" placeholder="Enter pincode" >
                                                                      <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <input type="email" class="form-control" id="email" name="email" value="aryan@gmail.com"placeholder="Enter email" >
                                                                      <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="password-group">
                                                                      <div class="password-field form-group">
                                                                                ...
                                                                                <input type="password" class="form-control" value="Aryan123" id="password" name="password" placeholder="Enter password" >
                                                                                <span class="text-danger">
...
</html><?php /**PATH C:\laragon\www\extra-tasks\resources\views/admin/edit_customer.blade.php ENDPATH**/ ?>