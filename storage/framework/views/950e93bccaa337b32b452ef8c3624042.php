                              ...
                              <div class="mx-3 mt-4">
                                        ...
                                        <div class="table-wrapper">
                                                  <table class="table
                                                            ...
                                                            <?php $__currentLoopData = $user_cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            
                                                                    <tr>
                                                                            <td class="text-center"><?php echo e($item->customer_id); ?></td>
                                                                            <td class="text-center"><?php echo e($item->book_name); ?></td>
                                                                            <td class="text-center"><?php echo e($item->book_price); ?>.00/-</td> 
                                                                            <td>1</td>
...
</html><?php /**PATH C:\laragon\www\clancart\resources\views/admin/customer_cart.blade.php ENDPATH**/ ?>