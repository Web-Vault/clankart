...
<script src="<?php echo e(URL::to('/')); ?>/js/bootstrap.min.js"></script>
                                                  ...
                                                  <div class="table-wrapper">
                                                            <table class="table
                                                                      ...
                                                                      <tbody>
                                                                                <tr>
                                                                                          <td>1</td>
                                                                                          <td onclick="toggleCustomerDetails(this)">Customer
                                                                                                    Name</td>
                                                                                          ...
                                                                                          <td>123,
                                                                                                    ...
                                                                                                    City,
                                                                                                    Country</td>
                                                                                                    <td><button class="btn btn-success btn-sm"><a class="text-decoration-none text-white" href="customer_cart">Cart</a></button></td>
                                                                                          <td>
                                                                                                    ...
                                                                                                    <button class="btn
                                                                                                              btn-primary
                                                                                                              btn-sm"><a href="edit-user" class="text-decoration-none text-white"> Edit
                                                                                                              Details</a></button>
                                                                                          </td>
                                                                                </tr>
          ...
          </html><?php /**PATH C:\laragon\www\extra-tasks\resources\views/admin/customer.blade.php ENDPATH**/ ?>