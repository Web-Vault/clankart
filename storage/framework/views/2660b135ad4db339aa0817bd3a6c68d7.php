 ...
 -->
                        ...
                        <div class="col-9 border">
                                <div class="messenger_list">
                                        <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


                                                <a href="<?php echo e(route('message_with_person', "partner_id"->$person['other_user'])); ?>" class="text-dark text-decoration-none">
                                                        <div class="container person border d-flex my-2 p-2">
                                                                <div class="profile" style="width: 15%; margin-right: 10px;">
                                                                        <img src="<?php echo e(asset('upload/' . ($person['other_user']->profile_picture ?? 'default-avatar.png'))); ?>" class="img border" style="width: 60%; border-radius: 60%;" alt="Profile">
                                                                </div>
                                                                <div class="seller_info d-flex align-items-left flex-column justify-content-center">
                                                                        <h4 class="name"><?php echo e($person['other_user']->firstname); ?> </h4>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\clancart\resources\views/chats.blade.php ENDPATH**/ ?>