...
<head>
          ...
          <style>
                    ...
                    .main-content .wishlist-item img {
                              width: 150px;
                              height: auto;
                              margin-right: 20px;
                    ...
                    .main-content .wishlist-item .wishlist-item-description {
                              flex-grow: 1;
                              margin-right: 20px;
                    }

                    .main-content .wishlist-item .wishlist-item-description p {
                              margin: 0;
                              color: #007bff;
                              font-size: 18px;
                    }

                    .main-content .wishlist-item .wishlist-item-actions {
                              display: flex;
                              flex-direction: column;
                    }

                    .main-content .wishlist-item .wishlist-item-actions button {
                    ...
                    .main-content .wishlist-item .wishlist-item-actions button:hover {
                              background-color: #0056b3;
                    }

                    .main-content .wishlist-item .wishlist-item-actions .delete-button {
                              background-color: #ddd;
                              color: #000;
                    }

                    .main-content .wishlist-item .wishlist-item-actions .delete-button:hover {
                                        ...
                                        <div class="cart-inner container w-auto d-flex flex-column">
                                                  ...
                                                  <div class="main-content my-3">
                                                            ...
                                                            <div class="wishlist-item">
                                                                      <div>
                                                                                <img src="<?php echo e(URL::to('/')); ?>/images/clankart-logo.png" alt="Book Image">
                                                                                <div class="wishlist-item-description">
                                                                                          <p>This is a book of social science in a very excellent condition.</p>
                                                                                </div>
                                                                      </div>
                                                                      <div class="wishlist-item-actions">
                                                                                <button class="delete-button">Delete from Wishlist</button>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\extra-tasks\resources\views/wishlist.blade.php ENDPATH**/ ?>