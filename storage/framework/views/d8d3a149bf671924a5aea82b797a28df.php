                                        ...
                                        <div class="collapse
                                                  ...
                                                  <ul class="navbar-nav
                                                            ...
                                                            <li class="nav-item none">
                                                                      <a class="nav-link
                                                                                          text-white" href="<?php echo e(URL::to('/')); ?>/a-index">
                                                                                <i class="fas
                                                                                                    fa-home"></i>
                                                                                Dashboard
                                                                      </a>
                                                                      ...
                                                                      <tr>
                                                                                ...
                                                                                <td>
                                                                                          <button class="btn
                                                                                                              btn-sm
                                                                                                              btn-success
                                                                                                              btn-confirm" data-order-id="1001"><a href="<?php echo e(URL::to('/')); ?>/confirm_order/<?php echo e($item->id); ?>" class="text-decoration-none text-white">Confirm</a></button>
                                                                                          <button class="btn
                                                                                                              btn-sm
                                                                                                              btn-danger
                                                                                                              btn-cancel" data-order-id="1001"> <a href="<?php echo e(URL::to('/')); ?>/cancel_order/<?php echo e($item->id); ?>" class="text-decoration-none text-white">Cancel</a> </button>
                                                                                </td>
                                                                      </tr>
...
</html><?php /**PATH C:\laragon\www\clancart\resources\views/admin/index.blade.php ENDPATH**/ ?>