                    ...
                    <div id="page-content-wrapper">
                              ...
                              <div class="container-fluid">
                                        ...
                                        <div class="row mt-4">
                                                  ...
                                                  <div class="col-md-4">
                                                            <div class="form-group">
                                                                      ...
                                                                      <select class="form-control
                                                                                          dropdown-categories" id="categoryFilter">
                                                  ...
                                                  <div class="col-md-8
                                                                      text-right">
                                                            <a href="a-add-product"><button class="btn
                                                                                btn-primary">Add
                                                                                New
                                                                                Product</button></a>
                                                  </div>
                                                  ...
                                                  <table class="table
                                                            ...
                                                            <tbody>
                                                                      <tr>
                                                                                ...
                                                                                <td>Electronics</td>
                                                                                <td>$100.00</td>
                                                                                <td><Button class="btn btn-success btn-sm"><a href="product_review" class="text-white text-decoration-none">product_review</a></Button></td>
                                                                                <td>10pcs</td>
                                                                                <td>
                                                                                          <button class="btn
                                                                                                              btn-sm
                                                                                                              btn-primary
                                                                                                              btn-edit" data-product-id="1"> <a href="edit-product" class="text-decoration-none text-white">Edit</a></button>
                                                                                          <button class="btn
                                                                                                              btn-sm
                                                                                                              btn-danger
                                                                                                              btn-delete" data-product-id="1"> Delete</button>
                                                                                </td>
                                                                      </tr>
                                                                      <tr>
                                                                                <td>2</td>
                                                                                ...
                                                                                <td>
                                                                                          <button class="btn
                                                                                                              btn-sm
                                                                                                              btn-primary
                                                                                                              btn-edit" data-product-id="2">Edit</button>
                                                                                          <button class="btn
                                                                                                              btn-sm
                                                                                                              btn-danger
                                                                                                              btn-delete" data-product-id="2">Delete</button>
                                                                                </td>
                                                                      </tr>
...
</html><?php /**PATH C:\laragon\www\extra-tasks\resources\views/admin/product.blade.php ENDPATH**/ ?>