            ...
            <div class="mx-3 mt-4">
                <div class="container mt-5">
                    <div class="d-flex justify-content-between align-items-center">
                        <!-- <h1>Harry Potter series' Reviews</h1> -->
                    </div>
                </div>
                <!-- Customers Table -->
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $review; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        <td class=""><?php echo e($item->id); ?></td>
                                        <td class=""><?php echo e($item->customer_id); ?></td>
                                        <td class=""><?php echo e($item->rating_value); ?></td>
                                        <td class=""><?php echo e($item->review_text); ?></td>
                                        <td>
                                            <?php if($item->Approval != "yes"): ?>
                                            
                                            <button class="btn btn-primary btn-sm"> 
                                                <a href="<?php echo e(URL::to('/')); ?>/approve_review/<?php echo e($item->id); ?>" class="text-white text-decoration-none"> Approve </a>
                                            </button>
...
</html><?php /**PATH C:\laragon\www\clancart\resources\views/admin/product-review.blade.php ENDPATH**/ ?>