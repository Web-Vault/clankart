                              ...
                              <div class="mx-3 mt-4">
                                        ...
                                        <div class="table-wrapper">
                                                  <table class="table
                                                            ...
                                                            <?php if(isset($all_coupon)): ?>

                                                            <?php $__currentLoopData = $all_coupon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        
                                                            <tr>
                                                                <td class="text-center"><?php echo e($coupon->id); ?></td>
                                                                <td class="text-center"><?php echo e($coupon->coupon_code); ?></td>
                                                                <td class="text-center"><?php echo e($coupon->discount_value); ?></td> 
                                                                <td><?php echo e($coupon->applicable_amount); ?></td>
                                                                <td class="text-center"><?php echo e($coupon->activation_time); ?></td>
                                                                <td class="text-center"><?php echo e($coupon->deactivation_time); ?></td>
...
</html><?php /**PATH C:\laragon\www\clancart\resources\views/admin/offers.blade.php ENDPATH**/ ?>