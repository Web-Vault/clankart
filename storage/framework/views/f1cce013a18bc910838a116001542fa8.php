...
<body>
          ...
          <div class="container rounded-1 border cart-container my-5 mx-auto">
                    <p class="p-3 fs-3">Check Out - <small> Make the product yours by paying.</small></p>
          </div>
          ...
          <div class="cart-container container rounded border my-5 mx-auto  cart-main">
                    ...
                    <div class="cart-inner container w-auto my-3">
                              <div class="inner-cart-container border-bottom rounded-0">
                                        <div class="cart-item">
                                                  ...
                                                  <div class="item-details">
                                                            ...
                                                            <div class="item-quantity">Qty: <input type="number" name="qty" id="qty" value="1"></div>
                              ...
                              <div class="total-price-details">
                                        ...
                                        <a href="#" class="checkout-button">ENTER DELIVERY ADDRESS</a>
                              </div>
                    </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\extra-tasks\resources\views/checkout.blade.php ENDPATH**/ ?>