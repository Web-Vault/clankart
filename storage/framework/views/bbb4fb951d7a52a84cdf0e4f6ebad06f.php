...
<head>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js"
                ...
                <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/view_css/master.css">
</head>
...
<body>
        <div class="header">
                <header class="d-flex align-items-center">
                        <div class="logo-img">
                                <a href="<?php echo e(URL::to('/')); ?>"><img src="<?php echo e(URL::to('/')); ?>/images/clankart-logo.png"
                                                alt="clanKart"></a>
                        </div>
        ...
        <main>
                                                        ...
                                                        <a class="link" href="<?php echo e(URL::to('/')); ?>/profile">
                                                                        <div class="profile"
                                                                                        ...
                                                                                        <div class="profile-icon">
                                                                                                        <img src="<?php echo e(URL::to('/')); ?>/images/default-profile.png" alt="profile"
                ...
                <a class="link" href="<?php echo e(URL::to('/')); ?>/orders">
                        <div class="profile">
                                <div class="profile-icon">
                ...
                <a class="link" href="<?php echo e(URL::to('/')); ?>/selling-orders">
                        <div class="profile">
                                <div class="profile-icon">
                ...
                <?php if(session()->has('customer_email')): ?>
                                ...
                                <?php else: ?>
                                                                        ...
                                                                        <a class="link" href="<?php echo e(URL::to('/')); ?>/login">
                                                                                        <div class="profile">
                                                                                                        <div class="profile-icon">
                                                                                                                        <img src="<?php echo e(URL::to('/')); ?>/images/logout.png" alt="categories">
                                                                                                        </div>
...
</html><?php /**PATH C:\laragon\www\clancart\resources\views/master.blade.php ENDPATH**/ ?>