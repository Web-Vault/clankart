...
<script src="<?php echo e(URL::to('/')); ?>/js/bootstrap.min.js"></script>
                                        ...
                                        <div class="mx-3 mt-4">
                                                  <div class="container mt-5">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                      <h1>Customers</h1>
                                                                      <a href="a-add-user" class="btn btn-primary">Add User</a>
                                                            </div>
                                                  </div>
                                                  <!-- Customers Table -->
                                                                      ...
                                                                      <tbody>
                                                                        ...
                                                                        <tr>
                                                                              <td><?php echo e($customer->id); ?></td>
                                                                                          ...
                                                                                          <td><button class="btn btn-success btn-sm"><a class="text-decoration-none text-white" href="<?php echo e(URL::to('/')); ?>/customer_cart/<?php echo e($customer->id); ?>">Cart</a></button></td>
                                                                                          <td>
                                                                                                
                                                                                                <button class="btn
                                                                                                btn-danger
                                                                                                btn-sm"><a href="<?php echo e(URL::to('/')); ?>/remove-user/<?php echo e($customer->id); ?>" class="text-decoration-none text-white">Remove
                                                                                                      Account</a></button>
                                                                                                      <button class="btn
                                                                                                      btn-primary
                                                                                                      btn-sm"><a href="<?php echo e(URL::to('/')); ?>/edit-user/<?php echo e($customer->id); ?>" class="text-decoration-none text-white"> Edit
                                                                                                            Details</a></button>
                                                                                                      </td>
                                                                                                      <td>
                                                                                                            <?php if($customer->activate == 1): ?>
                                                                                                                  Varified
                                                                                                            <?php else: ?> 
                                                                                                                  Not Varified
                                                                                                            <?php endif; ?>
          ...
          </html><?php /**PATH C:\laragon\www\clancart\resources\views/admin/customer.blade.php ENDPATH**/ ?>