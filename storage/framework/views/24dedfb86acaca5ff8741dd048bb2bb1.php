...
<head>
          ...
          <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/view_css/profile.css">
                                                  ...
                                                  <form action="/update_profile" method="post" enctype="multipart/form-data" class="profile-form" id="profileForm">
                                                            ...
                                                            <div class="form-group name-group">
                                                                      <div class="name-field">
                                                                                ...
                                                                                <input type="text" id="first-name" name="firstname" placeholder="First Name" value="<?php echo e($profile->firstname); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                                      ...
                                                                      <div class="name-field">
                                                                                ...
                                                                                <input type="text" id="last-name" name="lastname" placeholder="Last Name" value="<?php echo e($profile->lastname); ?>">
                                                                                <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <input type="email" id="email" name="email" value="<?php echo e($profile->email); ?>">
                                                                      <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                                      ...
                                                                      <div class="email-verified">
                                                                                <img src="<?php echo e(URL::to('/')); ?>/images/verified-icon.png" alt="Verified">
                                                            ...
                                                            <div class="form-group">
                                                                      <div class="d-flex">
                                                                                ...
                                                                                <div class="phone-input mx-5 w-100">
                                                                                          ...
                                                                                          <input type="text" id="phone-number" name="phone_number" placeholder="Phone Number" value="<?php echo e($profile->mobile_number); ?>">
                                                                                          <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <input type="text" id="Address" name="Address" placeholder="City, State (Ex. Rajkot, Gujarat)" value="<?php echo e($profile->address); ?>">
                                                                      <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <input type="text" id="pincode" name="pincode" placeholder="Your Pincode" value="<?php echo e($profile->pincode); ?>">
                                                                      <span class="text-danger">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\clancart\resources\views/profile.blade.php ENDPATH**/ ?>