                                                  ...
                                                  <form action="edit-product-form" method="post">
                                                            ...
                                                            <div class="name-group">
                                                                      <div class="name-field form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="productName" name="productName" placeholder="Enter product name" value="Harry potter Book">
...
unset($__errorArgs, $__bag); ?>
                                                                      ...
                                                                      <div class="name-field form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="title" name="title" placeholder="Enter title" value="Harry Potter and the sourcer's stone">
                                                                                <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="year-group">
                                                                      <div class="year-field form-group">
                                                                                ...
                                                                                <input type="number" class="form-control" id="year" name="year" placeholder="Enter year of publication" value="2007">
                                                                                <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                                      ...
                                                                      <div class="year-field form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="condition" name="condition" placeholder="Enter condition (e.g., New, Used)" value="fair">
                                                                                <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <textarea class="form-control" id="description" name="description" placeholder="Enter description" rows="4">Description of harry potter book</textarea>
                                                                      <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="price-group">
                                                                      <div class="price-field form-group">
                                                                                ...
                                                                                <input type="number" class="form-control" id="price" name="price" placeholder="Enter price" value="999">
                                                                                <span class="text-danger">
