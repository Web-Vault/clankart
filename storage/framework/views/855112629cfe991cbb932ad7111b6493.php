                    ...
                    <div id="page-content-wrapper">
                              ...
                              <div class="container-fluid">
                                        ...
                                        <div class="container mt-5">
                                                  ...
                                                  <form action="<?php echo e(URL::to('/')); ?>/edit-product-form" method="post">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <input type="hidden" name="id" value="<?php echo e($book->id); ?>">
                                                                      ...
                                                                      <div class="name-field form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="title" name="title" placeholder="Enter title" value="<?php echo e($book->book_title); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="year-group">
                                                                      <div class="year-field form-group">
                                                                                ...
                                                                                <input type="number" class="form-control" id="year" name="year" placeholder="Enter year of publication" value="<?php echo e($book->year); ?>">
                                                                                <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                                      ...
                                                                      <div class="year-field form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="condition" name="condition" placeholder="Enter condition (e.g., New, Used)" value="<?php echo e($book->condition); ?>">
                                                                                <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <textarea class="form-control" id="description" name="description" placeholder="Enter description" rows="4"><?php echo e($book->description); ?></textarea>
                                                                      <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <input type="text" class="form-control" id="author_name" name="author_name" placeholder="Enter author name" value="<?php echo e($book->author_name); ?>">
                                                                      <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="price-group">
                                                                      <div class="price-field form-group">
                                                                                ...
                                                                                <input type="number" class="form-control" id="price" name="price" placeholder="Enter price" value="<?php echo e($book->price); ?>">
                                                                                <span class="text-danger">
...
</html><?php /**PATH C:\laragon\www\extra-tasks\resources\views/admin\edit-product.blade.php ENDPATH**/ ?>