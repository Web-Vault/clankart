...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="name-group">
                                                                      <div class="name-field form-group">
                                                                                ...
                                                                                <span class="text-danger">
                                                                                          <?php $__errorArgs = ['applicable_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <span class="text-danger">
                                                                                <?php $__errorArgs = ['activation_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <span class="text-danger">
                                                                                <?php $__errorArgs = ['deactivation_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</html><?php /**PATH C:\laragon\www\extra-tasks\resources\views/admin/add-coupon.blade.php ENDPATH**/ ?>