                                                  ...
                                                  <form action="{{URL::to('/')}}/edit_user_info" method="post">
                                                            ...
                                                            <input type="hidden" name="id" value="{{ $user->id }}">
                                                                      ...
                                                                      <div class="name-field form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="firstName" value="{{ $user->firstname }}" name="firstName" placeholder="Enter first name" >
                                                                      ...
                                                                      <div class="name-field form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="lastName" value="{{ $user->lastname }}" name="lastName" placeholder="Enter last name" >
                                                                                <span class="text-danger">
                                                                                          @error('lastName')
                                                                                          {{ $message}}
                                                                                          @enderror
                                                            ...
                                                            <div class="form-group">
                                                                      ...
                                                                      <input type="text" class="form-control" id="pincode" value="{{ $user->pincode }}" name="pincode" placeholder="Enter pincode" >
                                                                      <span class="text-danger">
                                                                                @error('pincode')
                                                                                {{ $message}}
                                                                                @enderror
